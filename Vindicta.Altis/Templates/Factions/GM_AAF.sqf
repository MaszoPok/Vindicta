/*
AAF with Global Mobilization assets
*/
...
_veh set [T_VEH_car_unarmed, ["gmx_aaf_iltis_cargo_wdl"]];
_veh set [T_VEH_car_armed, ["gmx_aaf_iltis_milan_wdl"]];
_veh set [T_VEH_MRAP_unarmed, ["I_MRAP_03_F"]];
_veh set [T_VEH_MRAP_HMG, ["I_MRAP_03_hmg_F"]];
_veh set [T_VEH_MRAP_GMG, ["I_MRAP_03_gmg_F", "gmx_aaf_fuchsa0_reconnaissance_wdl"]];
_veh set [T_VEH_IFV, ["I_APC_tracked_03_cannon_F", "I_LT_01_AT_F", "I_LT_01_cannon_F", "gmx_aaf_m113a2dk_wdl"]];
_veh set [T_VEH_APC, ["I_APC_Wheeled_03_cannon_F", "gmx_aaf_m113a1g_apc_wdl", "gmx_aaf_m113a1g_apc_milan_wdl"]];
_veh set [T_VEH_MBT, ["I_MBT_03_cannon_F", "gmx_aaf_leopard1a1a1_wdl", "gmx_aaf_leopard1a3_wdl"]];
_veh set [T_VEH_MRLS, ["I_Truck_02_MRL_F"]];
_veh set [T_VEH_SPA, ["I_Truck_02_MRL_F"]];
_veh set [T_VEH_SPAA, ["I_LT_01_AA_F", "gmx_aaf_gepard1a1_wdl"]];
...
_veh set [T_VEH_stat_AT, ["I_static_AT_F", "gm_ge_army_milan_launcher_tripod"]];
...
_veh set [T_VEH_personal, ["I_Quadbike_01_F", "gm_ge_army_k125", "gmx_aaf_iltis_cargo_wdl"]];
_veh set [T_VEH_truck_inf, ["I_Truck_02_covered_F", "I_Truck_02_transport_F", "gmx_aaf_kat1_451_cargo_wdl", "gmx_aaf_kat1_454_cargo_wdl", "gmx_aaf_u1300l_cargo_wdl"]];
_veh set [T_VEH_truck_cargo, ["I_Truck_02_transport_F", "gmx_aaf_kat1_451_container_wdl"]];
_veh set [T_VEH_truck_ammo, ["I_Truck_02_ammo_F", "gmx_aaf_kat1_451_reammo_wdl"]];
_veh set [T_VEH_truck_repair, ["I_Truck_02_box_F", "gmx_aaf_bpz2a0_wdl", "gmx_aaf_u1300l_repair_wdl"]];
_veh set [T_VEH_truck_medical , ["I_Truck_02_medical_F", "gmx_aaf_u1300l_medic_wdl", "gmx_aaf_m113a1g_medic_wdl"]];
_veh set [T_VEH_truck_fuel, ["I_Truck_02_fuel_F", "gmx_aaf_kat1_451_refuel_wdl"]];
